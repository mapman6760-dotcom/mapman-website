...
const Login = ({ onLogin, logo }) => {
    ...
    const handleFinalSubmit = async () => {
        ...
        try {
            ...
            if (otpStr.length < 4) {
                throw new Error("Please enter the full 4-digit code");
            }
            const response = await verifyEmailOtp(email, parseInt(otpStr, 10));
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 bg-[#f0f9ff] relative overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: 'url("https://images.unsplash.com/photo-1526778548025-fa2f459cd5ce?w=1600&q=80")',
            ...
            <motion.div
                ...
                className="w-full max-w-4xl bg-white rounded-[1.5rem] overflow-hidden flex shadow-2xl flex-col md:flex-row min-h-[480px]"
            >
                ...
                <div className="hidden md:flex md:w-[45%] bg-gradient-to-br from-blue-600 to-blue-800 p-12 relative overflow-hidden text-white flex-col justify-center">
                    ...
                    <div className="relative z-10 space-y-4">
                        <div className="w-14 h-14 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center p-2.5 mb-6">
                            <img
                                src={logo}
                                alt="Logo"
                            ...
                            >
                                <div className="space-y-1">
                                    ...
                                    <p className="text-slate-400 text-xs font-medium">
                                        Verify your email to explore the ecosystem
                                    </p>
                                </div>
                                ...
                                <form onSubmit={handleNext} className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                type="email"
                                                required
                                                placeholder="example@mapman.com"
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => showToast("This feature currently not available")}
                            ...
                            >
                                ...
                                <div className="flex justify-between gap-3">
                                    {otp.map((data, index) => (
                                        <input
                                            ...
                                            type="text"
                                            maxLength="1"
                                            className="w-full h-16 text-center text-2xl font-black rounded-xl border-2 border-slate-100 bg-slate-50 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10 outline-none transition-all duration-200"
                                            value={data}
                                ...
                                <p className="text-center text-sm font-bold text-slate-500">
                                    ...
                                    <button
                                        onClick={() => {
                                            setError(null);
                                            sendEmailOtp(email).catch((err) => setError(err.message));
                                        }}
