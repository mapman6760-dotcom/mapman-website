...
const CategoryVideos = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full mb-6 md:mb-10 overflow-hidden shadow-xl border-b border-slate-800 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 py-6 md:py-8 lg:py-10 px-6 md:px-8 lg:px-12 flex flex-col lg:flex-row lg:items-center justify-between gap-6 z-10">
