...
const VideoFeed = () => {
  ...
  const handleOpenEdit = async (vid) => {
    try {
      ...
      setUploadForm({
        ...
        shopName:
          vid.shopName || currentShop?.shopName || currentShop?.name || "",
      });
      setVideoFile(null);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // 2. Fetch Videos
      const endpoint =
        activeTab === "all" ? "/shop/getCategoryVideos" : "/shop/myVideos";
                ...
                try {
                  ...
                  if (
                    ...
                    setUploadForm({
                      ...
                      shopName: activeShop.shopName || activeShop.name || "",
                    });
                    setShowUploadModal(true);
                  } else {
                    navigate("/edit-shop");
